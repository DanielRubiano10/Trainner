...
class Trainner(models.Model):
    ...
    actividad = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='actividad', null=True)
    
    def __str__(self):
        return f"Trainner {self.id}: {self.get_sexo_display()} -  Edad:{self.edad}"